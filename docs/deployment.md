...
完整的分步部署说明，从构建镜像到查看链路追踪。整体架构与设计原理见 [`architecture.md`](architecture.md)，README 的「快速开始」是本指南的精简版。

## 目录
1. [项目代码说明](#项目代码说明)
2. [步骤1: 构建和推送镜像](#步骤1-构建和推送镜像)
3. [步骤2: 配置EKS权限](#步骤2-配置eks权限)
4. [步骤3: 部署到EKS](#步骤3-部署到eks)
5. [步骤4: 创建持续流量生成器](#步骤4-创建持续流量生成器)
6. [步骤5: 查看链路追踪](#步骤5-查看链路追踪)
7. [故障排查](#故障排查)
8. [清理](#清理)
